...
import pictureProfile from '../assets/profile.webp';
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      <main className="pt-21 px-4">
        <div className="max-w-6xl mx-auto bg-white rounded-2xl shadow-xl p-6 grid grid-cols-1 md:grid-cols-2 gap-12">
          {/* Left Column */}
          <div className="flex flex-col items-start space-y-0 border-r pr-8">
          <h2 className="text-3xl font-extrabold text-gray-900 mb-1 text-left">Profile Info</h2>

<div className="flex flex-wrap gap-x-6 gap-y-2 text-gray-700 text-base font-medium">
  ...
  <p><span className="font-semibold">Email:</span> {profile.email}</p>
          ...
          <div className="flex flex-col justify-center space-y-2">
            {/* Username Update */}
            <h2 className="text-3xl font-extrabold text-gray-900 mb-1 text-left">Update Profile</h2>
            <div>
